...
[Docker Registry UI](https://github.com/Quiq/docker-registry-ui) is web ui for docker registry.
...
```shell
helm upgrade --install --namespace default --values ./my-values.yaml my-release example/docker-registry-ui
```

## Configuration

The following table lists the configurable parameters of the _Docker Registry UI_ chart and their default values.

| Parameter                          | Description                                                                                                                      | Default                             |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `image.repository`                 | Image repository.                                                                                                                | `quiq/docker-registry-ui`           |
